...
class FeatureExtractor(object):
    ...
    def extract_feats_from_string(self, string):
        ...
        voc2 = ['травмат', 'винтовка', 'мосина', 'газовый', 'пистолет', 'бронежилет', 'бронник', 'боевой',
                'оружие', 'мм', 'патрон', 'шт', 'наган', 'нож', 'огнестрел', 'тт',
                'оса', 'пм', 'двухстволк', 'пистолет', 'разрешение', 'макарыч', 'патрон', 'иж', 'калаш',
                'калашников', 'ствол', 'bitcoin', 'криптовалюта', 'работа', 'заработок', 'кокаин', 'гаш', 'меф', '']
        word_arr = []
        for w1 in voc1:
            a = [w1]
            a.extend(voc2)
